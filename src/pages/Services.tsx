...
const services = [
  {
    ...
    mediaSrc: '/src/assets/images/services/1. pyhsiotherapy.jpg',
    description:
  ...
  },
  {
    ...
    mediaSrc: '/src/assets/images/services/2. osteopathy.mp4',
    description:
  ...
  },
  {
    ...
    mediaType: 'image' as const,
    mediaSrc: '/src/assets/images/services/3. chiropractic.jpg',
    description:
  ...
  },
  {
    ...
    mediaType: 'video' as const,
    mediaSrc: '/src/assets/images/services/4. exercise therapy.mp4',
    description:
  ...
  },
  {
    ...
    mediaType: 'image' as const,
    mediaSrc: '/src/assets/images/services/5. manual pyhsical therapy.jpg',
    description:
  ...
  },
  {
    ...
    mediaType: 'video' as const,
    mediaSrc: '/src/assets/images/services/6. woman healyh physiotherapy.mp4',
    description:
  ...
  },
  {
    ...
    mediaType: 'image' as const,
    mediaSrc: '/src/assets/images/services/7. Pelvic Floor Rehabilitation.jpg',
    description:
  ...
  },
  {
    ...
    mediaType: 'video' as const,
    mediaSrc: '/src/assets/images/services/8.  Evidence-Based Falls Prevention.mp4',
    description:
  ...
  },
  {
    ...
    mediaType: 'image' as const,
    mediaSrc: '/src/assets/images/services/9 Physiotherapy at Home.jpg',
    description:
  ...
  },
  {
    ...
    mediaType: 'video' as const,
    mediaSrc: '/src/assets/images/services/10 . Childbirth Education.mp4',
    description:
              ...
              <div className="relative overflow-hidden rounded-3xl rounded-b-none">
                {service.mediaType === 'image' ? (
                  <img
                    ...
                    alt={service.title}
                    className="h-52 w-full object-cover transition duration-700 ease-out group-hover:scale-105 group-hover:brightness-110 md:h-64"
                  />
                ) : (
                  <video
